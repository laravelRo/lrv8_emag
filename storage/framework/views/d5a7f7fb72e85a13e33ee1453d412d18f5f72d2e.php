<?php $__env->startSection('content'); ?>
    <main>
        <div class="container-fluid px-4">
            ...
            <div class="card p-4">
                <form action="<?php echo e(route('sections.add')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input onblur="setSlug()" name="name" value="<?php echo e(old('name')); ?>" type="text"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-3">
                            ...
                            <input name="slug" value="<?php echo e(old('slug')); ?>" type="text"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input name="description" value="<?php echo e(old('description')); ?>" type="text"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-2 align-bottom">
                            ...
                            <input name="position" type="number" value="<?php echo e(old('position')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                id="icon" value="<?php echo e(old('icon')); ?>">
                        ...
                        <div class="col-md-2 align-bottom">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" value="1" name="active" id="active1"
                                    <?php echo e(old('active') == 1 ? 'checked' : ''); ?> <?php if(is_null(old('active'))): ?> checked <?php endif; ?>>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="active" id="active2" value="0"
                                    <?php echo e(old('active') === 0 ? 'checked' : ''); ?>>
                        ...
                        <div class="col-md-2 align-bottom">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="promo" id="promo1" value="0"
                                    <?php echo e(old('promo') === 0 ? 'checked' : ''); ?> <?php if(is_null(old('promo'))): ?> checked <?php endif; ?>>
                                <label class="form-check-label" for="active1">
                                    Standard
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="promo" id="promo2" value="1"
                                    <?php echo e(old('promo') == 1 ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                    id="meta_description" value="<?php echo e(old('meta_description')); ?>">
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lrv8_emag\resources\views/admin/content/sections/new.blade.php ENDPATH**/ ?>