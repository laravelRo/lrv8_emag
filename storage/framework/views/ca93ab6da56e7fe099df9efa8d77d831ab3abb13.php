<?php $__env->startSection('meta_title', 'Creare cont e-mag'); ?>
<?php $__env->startSection('meta_description', 'Creare cont pentru utilizatorii noi ai e-mag online shopping'); ?>
<?php $__env->startSection('meta_keywords', 'emag larvel 8, new accout, register account'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center py-4 justify-content-center" style="min-height: 300px">
            ...
            <form style="width:500px;" action="<?php echo e(route('register')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('front.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lrv8_emag\resources\views/front/user/register.blade.php ENDPATH**/ ?>