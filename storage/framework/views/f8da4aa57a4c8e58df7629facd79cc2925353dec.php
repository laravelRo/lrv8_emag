    ...
    <div class="sb-sidenav-menu">
        <div class="nav">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manager')): ?>
                ...
                <a class="nav-link" href="<?php echo e(route('show.staff')); ?>">
                    <div class="sb-nav-link-icon"><i class="fas fa-user-shield"></i></div>
                    Staff
                </a>
                <a class="nav-link" href="<?php echo e(route('show.users')); ?>">
                    <div class="sb-nav-link-icon"><i class="fas fa-users"></i></div>
                    Users
                </a>
            <?php endif; ?>
            <div class="sb-sidenav-menu-heading">Content</div>
            <a class="nav-link" href="<?php echo e(route('sections.list')); ?>">
                <div class="sb-nav-link-icon"><i class="fas fa-user-shield"></i></div>
                Sections
            </a>
...
<?php /**PATH C:\xampp\htdocs\lrv8_emag\resources\views/admin/partials/sidenav.blade.php ENDPATH**/ ?>